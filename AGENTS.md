...
- Agents must read and follow `ProjectBasis.md` before making changes.
- `ProjectBasis.md` defines mandatory worklog, implementation-document, and
  maintained-document requirements.
- Treat tasks as incomplete if the required updates from `ProjectBasis.md` have
  not been made.
